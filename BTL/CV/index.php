    ...
    <header id="header">
      ...
      if($data['github']!=""){
        ...
        ?>
            ...
            <nav class="nav-menu">
                <ul>
                    <li class=""><a href="#hero"><i class="bx bx-home"></i> <span>Trang chủ</span></a></li>
                    <li><a href="#about"><i class="bx bx-user"></i> <span>Giới thiệu</span></a></li>
                    <li><a href="#skills"><i class='bx bxl-dev-to'></i>Kỹ năng</a></li>
                    <li><a href="#resume"><i class="bx bx-file-blank"></i> <span>Học tập</span></a></li>
                    <li><a href="#portfolio"><i class="bx bx-book-content"></i> Ảnh</a></li>
